...
static unsigned int default_efficient_freq_lp[] = {979200};
static u64 default_up_delay_lp[] = {200 * NSEC_PER_MSEC};

static unsigned int default_efficient_freq_hp[] = {1171200};
static u64 default_up_delay_hp[] = {400 * NSEC_PER_MSEC};

static unsigned int default_efficient_freq_pr[] = {1632000};
